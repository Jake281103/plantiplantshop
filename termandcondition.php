...
<body>
    ...
    <div class="fixed-bottom">
        <a href="./termandcondition.php" class="btn-backtotops"><i class="fas fa-arrow-up"></i></a>
    </div>
            ...
            <div class="container-fluid mt-5">
                <div class="row">
                    ...
                    <div class="container mt-5">
                        <h1 class="text-center mb-4 mb-5">Terms and Conditions</h1>
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                <div class="card">
                                    <div class="card-body p-5">
                                        <h5 class="card-title mb-3">Introduction</h5>
                                        <p class="card-text mb-5">Welcome to Planti Plant Shop. These Terms and Conditions govern your use of our website and the purchase of products from us. By accessing or using our website, you agree to be bound by these Terms and Conditions.</p>

                                        <h5 class="card-title mb-3">Eligibility</h5>
                                        <p class="card-text mb-5">You must be at least 18 years old to use our website and purchase products from us. By using our website, you represent and warrant that you are at least 18 years old.</p>

                                        <h5 class="card-title mb-3">Orders and Payment</h5>
                                        <p class="card-text">All orders are subject to acceptance and availability. We reserve the right to refuse or cancel any order for any reason. Prices for our products are subject to change without notice.</p>

                                        <p class="card-text mb-5">We accept various forms of payment, including credit cards, debit cards, and PayPal. By providing payment information, you represent and warrant that you are authorized to use the payment method.</p>

                                        <h5 class="card-title mb-3">Shipping and Delivery</h5>
                                        <p class="card-text mb-5">We aim to ship products within the estimated delivery times provided. However, delivery times are not guaranteed and may be affected by factors beyond our control. We are not liable for any delays in delivery.</p>

                                        <h5 class="card-title mb-3">Returns and Refunds</h5>
                                        <p class="card-text mb-5">Our return policy is outlined separately on our website. Please refer to our Return Policy page for detailed information.</p>

                                        <h5 class="card-title mb-3">Limitation of Liability</h5>
                                        <p class="card-text mb-5">To the fullest extent permitted by law, Planti Plant Shop shall not be liable for any indirect, incidental, special, or consequential damages arising from the use of our website or the purchase of products from us.</p>

                                        <h5 class="card-title mb-3">Governing Law</h5>
                                        <p class="card-text mb-5">These Terms and Conditions are governed by and construed in accordance with the laws of the United States. Any disputes arising out of or relating to these Terms and Conditions shall be resolved in the courts of the United States.</p>

                                        <h5 class="card-title mb-3">Changes to These Terms</h5>
                                        <p class="card-text mb-5">We reserve the right to modify these Terms and Conditions at any time. Any changes will be effective immediately upon posting on our website. Your continued use of our website after any changes constitutes your acceptance of the new Terms and Conditions.</p>

                                        <h5 class="card-title mb-3">Contact Us</h5>
                                        <p class="card-text mb-5">If you have any questions about these Terms and Conditions, please contact us at <a href="mailto:info@plantiplantshop.com" class="text-success">info@plantiplantshop.com</a> or call us at (123) 456-7890. We are here to help!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
