...
$orderlines = getorderline($orderid);
...
<body>
    ...
    <div class="fixed-bottom">
        <a href="./orderdetail.php" class="btn-backtotops"><i class="fas fa-arrow-up"></i></a>
    </div>
                        ...
                        <div class="col-lg-10 col-md-11 mx-auto">
                            ...
                            <div class="row">
                                <div class="col-12 p-0 py-1">
                                    <p class="text-success">Home > My Order ><span class="fw-bold"> Order Detail</span></p>
                                </div>
                                    ...
                                    <div class="card-body d-flex justify-content-center align-items-center">
                                        <table class="table table-hover mt-4 mb-4">
                                            <tr class="fw-bold table-secondary">
                                                <td scope="col" class="">Product ID</td>
                                                <td scope="col" class="">Product Name</td>
                                            ...
                                            ?>
                                                <tr class="align-middle">
                                                    <td scope="row" class="py-3"><?php echo $orderline['productid'] ?></td>
                                                    <?php
                                                    try {
                                                        $pid = $orderline['productid'];
                                                        $conn = connect();
                                                    ...
                                                    ?>
                                                    <td class="py-3"><a href="./productdetail.php?pid=<?php echo $orderline['productid'] ?>" class="nav-link"><?php echo $product['pname'] ?></a></td>
                                                    <td class="py-3">
                                                        <a href="./productdetail.php?pid=<?php echo $orderline['productid'] ?>">
                                                            <img src="<?php echo $productimages[0]['url'] ?>" width="70" alt="Product<?php echo $pid ?>" />
                                                        </a>
                                                    </td>
                                                    <td class="text-danger text-center py-3"><?php echo $orderline['quantity'] ?></td>
                                                </tr>
                                            <?php } ?>
                                            <tr>
                                                <td scope="row" class="py-3"></td>
                                                <td class="py-3"></td>
                                                <td class="text-danger fw-bold py-3">Sub Total:</td>
                                                <td class="text-danger text-center fw-bold py-3">$<?php echo number_format($subtotal, 2) ?></td>
                                            </tr>
                                        </table>
                                    </div>
