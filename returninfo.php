...
<body>
    ...
    <div class="fixed-bottom">
        <a href="./returninfo.php" class="btn-backtotops"><i class="fas fa-arrow-up"></i></a>
    </div>
    ...
    <main class="prodcut-section">
        ...
        <div class="text-center" style="background-image: url('./assets/img/banner/banner2.jpg');background-size:cover;">
            <div class="container-fluid py-5 product-page-headers">
                <h1 class="text-uppercase">Return Information</h1>
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav mt-4 mb- pb-2 border-bottom">
            <div class="container-fluid">
                <ol class="breadcrumb">
                    ...
                    <?php } ?>
                    <li class="breadcrumb-item" aria-current="page">Return Info</li>
                </ol>
            ...
            <div class="container-fluid mt-5">
                <div class="row">
                    ...
                    <div class="container mt-5">
                        <h1 class="text-center mb-5">Return Policy</h1>
                        <div class="row">
                            <div class="col-md-9 offset-md-2">
                                <div class="card">
                                    <div class="card-body p-5">
                                        <h5 class="card-title mb-3">Our Return Policy</h5>
                                        <p class="card-text mb-5">We want you to be completely satisfied with your purchase. If you are not happy with your plants, you may return them under the following conditions:</p>

                                        <h5 class="card-title mb-3">Conditions for Returns</h5>
                                        <ul class="card-text mb-5">
                                            <li>Returns must be made within 30 days of delivery.</li>
                                            <li>Plants must be in their original condition and packaging.</li>
                                            <li>Proof of purchase is required for all returns.</li>
                                        </ul>

                                        <h5 class="card-title mb-3">How to Return an Item</h5>
                                        <p class="card-text mb-5">To initiate a return, please contact our customer service team at <a href="mailto:returns@plantiplantshop.com" class="text-success">returns@plantiplantshop.com</a> or call us at (123) 456-7890. Provide your order number and the reason for the return.</p>

                                        <p class="card-text mb-5">Once your return is approved, you will receive instructions on how to send your plants back to us. Please ensure that the plants are securely packaged to avoid damage during transit.</p>

                                        <h5 class="card-title mb-3">Refunds</h5>
                                        <p class="card-text mb-5">Once we receive your returned plants, we will inspect them and notify you of the status of your refund. If approved, your refund will be processed, and a credit will be applied to your original method of payment within 7-10 business days.</p>

                                        <h5 class="card-title mb-3">Exchanges</h5>
                                        <p class="card-text mb-5">If you wish to exchange your plants for different ones, please specify this when you contact us for a return. We will process the exchange once we receive and inspect your returned plants.</p>

                                        <h5 class="card-title mb-3">Non-returnable Items</h5>
                                        <p class="card-text">Certain items are non-returnable, including:</p>
                                        <ul class="card-text mb-5">
                                            <li>Gift cards</li>
                                            <li>Sale items</li>
                                        </ul>
                                        ...
                                        <p class="card-text mb-5 mb-3">If you have any questions about our return policy, please contact us at <a href="mailto:info@plantiplantshop.com" class="text-success">info@plantiplantshop.com</a> or call us at (123) 456-7890. We are here to help!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
