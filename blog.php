...
<body>
    ...
    <div class="fixed-bottom">
        <a href="./blog.php" class="btn-backtotops"><i class="fas fa-arrow-up"></i></a>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 px-5">
                        <div class="row">
                            <div class="col-lg-6 mb-5">
                                <div>
                                    <img src="./assets/img/blog/blog1.png" width="100%" />
                                </div>
                                <div class="mt-4 ms-1">
                                    <h4 class="text-success" style="letter-spacing: 2px;">Common Problems Faced by the Money Tree</h4>
                                    <span class="text-muted">Feb 11, 2024</span>
                                    <p class="small mt-3" style="letter-spacing: 2px; text-align:justify">The Money Tree, also known as Pachira aquatica scientifically, is a popular indoor plant because of its ease of care, stunning aesthetics, and positive presence indoors. It is a culturally . . .</p>
                                    <a href="https://www.ugaoo.com/blogs/gardening-basics/money-tree-care-and-common-plant-problems" class="text-success pb-5">Read More</a>
                                </div>
                            </div>
                            <div class="col-lg-6 mb-5">
                                <div>
                                    <img src="./assets/img/blog/blog2.png" width="100%" />
                                </div>
                                <div class="mt-4 ms-1">
                                    <h4 class="text-success" style="letter-spacing: 2px;">10 Plants You Didn't Know Were Epiphytic Plants</h4>
                                    <span class="text-muted">Mar 27, 2024</span>
                                    <p class="small mt-3" style="letter-spacing: 2px; text-align:justify">Before we go on with the list of plants that you didn't know were epiphytes, it's important to understand exactly what epiphytes are. They may seem like something but rest assured, they're . . .</p>
                                    <a href="https://www.ugaoo.com/blogs/gardening-basics/10-plants-you-didnt-know-were-epiphytes" class="text-success">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 px-5">
                        <div class="row">
                            <div class="col-lg-6 mb-5">
                                <div>
                                    <img src="./assets/img/blog/blog3.png" width="100%" />
                                </div>
                                <div class="mt-4 ms-1">
                                    <h4 class="text-success" style="letter-spacing: 2px;">Growing and Caring for the Song of India Plant</h4>
                                    <span class="text-muted">Jan 15, 2024</span>
                                    <p class="small mt-3" style="letter-spacing: 2px; text-align:justify">The Song of India plant, also called the "Song of Jamaica", is a popular ornamental plant. This Dracaena plant is known worldwide for its versatile ornamental usage and easy care requirements.  . . .</p>
                                    <a href="https://www.ugaoo.com/blogs/gardening-basics/song-of-india-care-tips-and-tricks" class="text-success pb-5">Read More</a>
                                </div>
                            </div>
                            <div class="col-lg-6 mb-5">
                                <div>
                                    <img src="./assets/img/blog/blog4.jpg" width="100%" />
                                </div>
                                <div class="mt-4 ms-1">
                                    <h4 class="text-success" style="letter-spacing: 2px;">Get Creative with These Small Garden Ideas!</h4>
                                    <span class="text-muted">May 12, 2024</span>
                                    <p class="small mt-3" style="letter-spacing: 2px; text-align:justify">Whether you're starting out as a beginner or have been a gardener for a long time, getting creative with decorating your garden is always a new and exciting idea. There are countless ways to make your garden appear more aesthetic, elevating the plant decor of your . . .</p>
                                    <a href="https://www.ugaoo.com/blogs/ornamental-gardening/get-creative-with-these-small-garden-ideas" class="text-success">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
