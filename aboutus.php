            ...
            <div class="container-fluid mt-5">
                <div class="row">
                    ...
                    <div class="container text-center mt-5">
                        <h2>Who We Are</h2>
                        <p class="px-5 mx-5" style="line-height: 27px;">Planti is an entirely new & unique online experience, where customers can browse through and purchase an extensive range of indoor and outdoor plants, gardening accessories & equipment, seeds, and fertilizers. The first of its kind in the region, planti is not just a store, but a learning platform for budding gardeners. Our website provides expert help on the care of each individual plant we offer, at no extra charge. We also raise awareness on the need to go green, the importance of planting more, and the advantages it offers.</p>
                        <img src="./assets/img/adv/adv8.jpg" width="800px" class="img-fluid my-5" alt="Image">
                        <div class="row mt-5 px-3">
                            <div class="col-md-4 px-5">
                                <i class="fas fa-puzzle-piece h1 pb-3"></i>
                                <h5>Design Quality</h5>
                                <p class="px-5">98% of our customers feel that Planti understands them and their needs</p>
                            </div>
                            <div class="col-md-4 px-5">
                                <i class="fas fa-headset h1 pb-3"></i>
                                <h5>Professional Support</h5>
                                <p class="px-5">92% of our customers believe that Planti has a unique and memorable personality</p>
                            </div>
                            <div class="col-md-4 px-5">
                                <i class=" far fa-heart h1 pb-3"></i>
                                <h5>Made With Love</h5>
                                <p class="px-5">88% of our customers believe we have a strong positive emotion</p>
                            </div>
                        </div>
                    </div>
                    <div class="container text-center mt-5 py-5" style="background: url(./assets/img/banner/productpageheader3.jpg);">
