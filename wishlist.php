...
if ($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET['pid'])) {
    ...
    if (!isset($_SESSION['wishlist'])) {
        $_SESSION['wishlist'] = array($pid);
    } else {
        if (!in_array($pid, $_SESSION['wishlist'])) {
            array_unshift($_SESSION['wishlist'], $pid);
        }
    }
}
...
if ($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET['deletaction'])) {
    ...
    if (($key = array_search($pid, $_SESSION['wishlist'])) !== false) {
...
<body>
    ...
    <div class="fixed-bottom">
        <a href="./wishlist.php" class="btn-backtotops"><i class="fas fa-arrow-up"></i></a>
    </div>
    ...
    <main class="prodcut-section">
        ...
        <div class="text-center" style="background-image: url('./assets/img/banner/banner2.jpg');background-size:cover;">
            <div class="container-fluid py-5 product-page-headers">
                <h1 class="text-uppercase">Wishlist</h1>
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav mt-4 mb- pb-2 border-bottom">
            <div class="container-fluid">
                <ol class="breadcrumb">
                    ...
                    <?php } ?>
                    <li class="breadcrumb-item" aria-current="page">Whishlist</li>
                </ol>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-muted text-center" scope="col">Stock Status</th>
                                        <th class="text-muted" scope="col"></th>
                                    </tr>
                                </thead>
                                <tbody>
                                                ...
                                                <tr class="align-middle">
                                                    <th class="text-success py-3" scope="row">
                                                        ...
                                                        <a href="./productdetail.php?pid=<?php echo $pid ?>">
                                                            <img src="<?php echo $productimages[0]['url'] ?>" width="80" alt="Product<?php echo $pid ?>" />
                                                        </a>
                                                    </th>
                                                    <td class="py-3" style="width: 400px;">
                                                        <h5 class="mt-2">
                                                            <a href="./productdetail.php?pid=<?php echo $pid ?>" class="nav-link"><?php echo $product['pname'] ?></a>
                                                        </h5>
                                                    </td>
                                                    ...
                                                    <td class="text-success text-center py-3">
                                                        <?php if ($product['quantity'] != 0) { ?>
                                                            <p class="text-success pt-2">Instock</p>
                                                        <?php } else { ?>
                                                    ...
                                                    <?php if (isset($_SESSION['email'])) { ?>
                                                        <td class="text-success py-3">
                                                            <button class="text-center h6 border-success reload-btns px-3 py-2" type="submit" name="updatecard">
                                                                <a href="./cart.php?pid=<?php echo $pid ?>" class="nav-link">Add to Cart<i class="fas fa-shopping-cart ms-2"></i></a>
                                                            </button>
                                                        </td>
                                                    <?php } ?>
                                                    <td class="text-danger py-3">
                                                        <a href="./wishlist.php?deletaction=delete&pid=<?php echo $pid ?>" class="nav-link mt-2"><i class="fas fa-times h4"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                    ...
                                    <?php } else { ?>
                                        <tr class="text-center">
                                            <td class="py-5" colspan="5">Product Not Found In Wistlist</td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
