...
<body>
    ...
    <div class="fixed-bottom">
        <a href="./orderrecord.php" class="btn-backtotops"><i class="fas fa-arrow-up"></i></a>
    </div>
                ...
                <div class="col-lg-3 col-md-4 border userleftsidebars">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 border-bottom py-3 ps-5 bordersuccesses">
                            <a href="./orderrecord.php" class="nav-link text-success">
                                <i class="fas fa-box-open h4 me-3 text-center"></i>
                                <span class="h5">My Order</span>
                            </a>
                        </div>
                        <div class="col-12 border-bottom py-3 ps-5">
                        ...
                        <div class="col-lg-10 col-md-11 mx-auto">
                            ...
                            <div class="row">
                                <div class="col-12 p-0 py-1">
                                    <p class="text-success">Home > <span class="fw-bold">My Order</span></p>
                                </div>
                                    ...
                                    <div class="card-body d-flex justify-content-center align-items-center">
                                        <table class="table table-hover mt-4 mb-4">
                                            <tr class="fw-bold table-secondary">
                                                <td scope="col" class="">Order ID</td>
                                                <td scope="col" class="">Date Purchased</td>
                                                <td scope="col" class="">Status</td>
                                                <td scope="col" class="">Total</td>
                                                <td scope="col" class="">Detail</td>
                                            </tr>
                                            ...
                                            ?>
                                                <tr>
                                                    <td scope="row" class="py-3"><?php echo $order['odid'] ?></td>
                                                    <td class="py-3"><?php echo $order['date'] ?></td>
                                                    <?php if($order['status'] == 'progress'){ ?>
                                                        <td class="py-3"><span class="bg-info small text-white fw-bold rounded p-1">In Progress</span></td>
                                                    <?php }elseif($order['status'] == 'delayed'){ ?>
                                                        <td class="py-3"><span class="bg-warning small text-white fw-bold rounded p-1">Delayed</span></td>
                                                    <?php }else{ ?>
                                                        <td class="py-3"><span class="bg-success small text-white fw-bold rounded p-1">Delivered</span></td>
                                                    <?php } ?>
                                                    <td class="text-danger py-3">$<?php echo $order['total'] ?></td>
                                                    <td class="text-danger py-3"><a href="./orderdetail.php?oid=<?php echo $order['odid'] ?>&subtotal=<?php echo $order['subtotal'] ?>" class="text-danger">Details</a></td>
                                                </tr>
                                            <?php } ?>
                                            <tr>
                                                <td scope="row" class="py-3"></td>
                                                <td class="py-3"></td>
