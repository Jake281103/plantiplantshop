...
<body>
    ...
    <div class="fixed-bottom">
        <a href="./deliveryinformation.php" class="btn-backtotops"><i class="fas fa-arrow-up"></i></a>
    </div>
    ...
    <main class="prodcut-section">
        ...
        <div class="text-center" style="background-image: url('./assets/img/banner/banner2.jpg');background-size:cover;">
            <div class="container-fluid py-5 product-page-headers">
                <h1 class="text-uppercase">Delivery Information</h1>
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav mt-4 mb- pb-2 border-bottom">
            <div class="container-fluid">
                <ol class="breadcrumb">
                    ...
                    <?php } ?>
                    <li class="breadcrumb-item" aria-current="page">Delivery Info</li>
                </ol>
            ...
            <div class="container-fluid mt-5">
                <div class="row">
                    ...
                    <div class="container mt-5">
                        <h1 class="text-center mb-5">Delivery Information</h1>
                        <div class="row">
                            <div class="col-md-9 offset-md-2">
                                <div class="card">
                                    <div class="card-body p-5">
                                        <h5 class="card-title">Delivery Times</h5>
                                        <p class="card-text mb-5">We aim to deliver your plants within 3-5 working days. Deliveries are made Monday to Friday, excluding public holidays.</p>

                                        <h5 class="card-title">Delivery Charges</h5>
                                        <p class="card-text mb-5">We offer free standard delivery on all orders over $50. For orders under $50, a flat delivery fee of $5 will be applied.</p>

                                        <h5 class="card-title">Packaging</h5>
                                        <p class="card-text mb-5">Our plants are carefully packaged to ensure they arrive in perfect condition. We use eco-friendly packaging materials to minimize our environmental impact.</p>

                                        <h5 class="card-title">Tracking Your Order</h5>
                                        <p class="card-text mb-5">Once your order has been dispatched, you will receive an email with a tracking number. You can use this number to track your delivery on our courier’s website.</p>

                                        <h5 class="card-title">International Delivery</h5>
                                        <p class="card-text mb-5">At this time, we only deliver within the United States. We hope to expand our delivery options in the near future.</p>

                                        <h5 class="card-title">Contact Us</h5>
                                        <p class="card-text mb-5">If you have any questions about your delivery, please contact us at <a href="mailto:info@plantiplantshop.com" class="text-success">info@plantiplantshop.com</a> or call us at (123) 456-7890.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
