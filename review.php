...
if (isset($_SESSION['email'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['reviewsubmit'])) {
        ...
        addreview($name, $title, $review, $rating, $customerid);
    }
}
...
function addreview($name, $title, $review, $rating, $cid)
{
    try {
        ...
        // echo $datetime;
        $conn = connect();
        $stmt = $conn->prepare("INSERT INTO review (customerid,rcname,rtitle,rcontent,rating,date) VALUES (:cid, :cname, :rtitle, :content, :rating, :date)");
...
<body>
    ...
    <div class="fixed-bottom">
        <a href="./review.php" class="btn-backtotops"><i class="fas fa-arrow-up"></i></a>
    </div>
                ...
                <div class="col-lg-3 col-md-4 border userleftsidebars">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 border-bottom py-3 ps-5 bordersuccesses">
                            <a href="./review.php" class="nav-link text-success">
                        ...
                        <div class="col-lg-10 col-md-11 mx-auto">
                            ...
                            <div class="row">
                                <div class="col-12 p-0 py-1">
                                    <p class="text-success">Home > <span class="fw-bold">Review</span></p>
                                </div>
                                                ...
                                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                                                    <table class="mt-4 mb-3">
                                                        <tr>
                                                            ...
                                                            <td class="py-2"><input type="text" name="name" id="name" class="form-control" autocomplete="on" required /></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="h5 pe-4 py-3" style="vertical-align:top;"><label for="rating1"><i class="fas fa-award"></i> Rating:</label></td>
                                                            <td class="py-2">
                                                                <div>
