...
<body>
    ...
    <div class="fixed-bottom">
        <a href="./address.php" class="btn-backtotops"><i class="fas fa-arrow-up"></i></a>
    </div>
                ...
                <div class="col-lg-3 col-md-4 border userleftsidebars">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 border-bottom py-3 ps-5 bordersuccesses">
                            <a href="./address.php" class="nav-link text-success">
                        ...
                        <div class="col-lg-10 col-md-11 mx-auto">
                            ...
                            <div class="row">
                                <div class="col-12 p-0 py-1">
                                    <p class="text-success">Home > <span class="fw-bold">Address</span></p>
                                </div>
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <table class="mt-4 mb-3">
                                            <tr>
                                                <td class="h6 pe-4 py-3"><i class="fas fa-home"></i> Home:</td>
                                                <?php if ($customer['homenumber'] != null) { ?>
                                                    <td class="small py-2">No. <?php echo $customer['homenumber']; ?></td>
                                                <?php } else { ?>
                                                    <td class="small py-2"> None</td>
                                                <?php } ?>
                                            </tr>
                                            <tr>
                                                <td class="h6 pe-4 py-3"><i class="fas fa-road"></i> Street:</td>
                                                <?php if ($customer['street'] != null) { ?>
                                                    <td class="small py-2"><?php echo $customer['street']; ?> Street</td>
                                                <?php } else { ?>
                                                    <td class="small py-2"> None</td>
                                                <?php } ?>
                                            </tr>
                                            <tr>
                                                <td class="h6 pe-4 py-3"><i class="fas fa-building"></i> Ward:</td>
                                                <?php if ($customer['ward'] != null) { ?>
                                                    <td class="small py-2"><?php echo $customer['ward']; ?></td>
                                                <?php } else { ?>
                                                    <td class="small py-2"> None</td>
                                                <?php } ?>
                                            </tr>
                                            <tr>
                                                <td class="h6 pe-4 py-3"><i class="fas fa-city"></i> Township:</td>
                                                <?php if ($customer['township'] != null) { ?>
                                                    <td class="small py-2"><?php echo $customer['township']; ?></td>
                                                <?php } else { ?>
                                                    <td class="small py-2"> None</td>
                                                <?php } ?>
                                            </tr>
                                            <tr>
                                                <td class="h6 pe-4 py-3"><i class="fas fa-globe-europe"></i> Region:</td>
                                                <?php if ($customer['region'] != null) { ?>
                                                    <td class="small py-2"><?php echo $customer['region']; ?></td>
                                                <?php } else { ?>
                                                    <td class="small py-2"> None</td>
                                                <?php } ?>
                                            </tr>
